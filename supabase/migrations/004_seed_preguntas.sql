-- =============================================================================
-- 004_seed_preguntas.sql
-- Semilla del banco de preguntas: tomadas del documento de la profesora
-- ("PREGUNTAS CULTURA GENERAL.docx"), limpiadas y clasificadas.
-- Se insertan solo si la tabla está vacía, para que puedas re-ejecutar la
-- migración sin duplicar datos.
-- =============================================================================
